...
void ReversedNumber(int arr[100], int arr2[100], int arrlength)
{
...
int main()
{
	...
	cout << "element 2 after elements copying array 1 and reversed order : " << endl;
	ReversedNumber(arr, arr2, arrLength);
